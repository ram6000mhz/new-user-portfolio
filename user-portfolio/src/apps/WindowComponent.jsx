    ...
    return(
        <div className="w-full h-full bg-background flex flex-col">
            <div className="window-header flex flex-row items-center justify-center bg-foreground 
                ...
                <div className="grow"/>
                <div className="cursor-pointer flex flex-col items-center justify-center hover:bg-foreground-highlight rounded h-full w-[30px] transition-all duration-100 active:scale-80" onClick={Minimize} onTouchEnd={(e)=>{e.preventDefault();Minimize();}}>
                    <Minus className="h-[15px]! w-[15px]! text-accent-icon"/>
                </div>
                <div className="cursor-pointer flex items-center justify-center hover:bg-foreground-highlight rounded h-full w-[30px] transition-all duration-100 active:scale-80" onClick={Window} onTouchEnd={(e)=>{e.preventDefault();Window();}}>
                ...
                <div className="cursor-pointer flex items-center justify-center hover:bg-red-300 rounded h-full w-[30px] transition-all duration-100 active:scale-80" onClick={Terminate} onTouchEnd={(e)=>{e.preventDefault();Terminate();}}>
